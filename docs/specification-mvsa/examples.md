...
[Syntax](syntax.md) (woordstreepjes, `|` / `||` op alle LSATB-regels,
[kolomuitlijning L↔SATB](syntax.md#canonieke-kolomuitlijning-lsatb)). Spaties
bijwerken: `python scripts/align_mvsa_columns.py examples/mvsa`. Oudere
