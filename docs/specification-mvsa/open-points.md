# Open punten (mvsa draft)

| Punt                                    | Toelichting                                                             | Richting                                                                       |
| --------------------------------------- | ----------------------------------------------------------------------- | ------------------------------------------------------------------------------ |
| Blokhergebruik                          | Secties of stemmen hergebruiken (`@voices`, deelbereiken)               | Bewust later; zie experiment in `examples/mvsa/trisagion-8a-slav-hemelum.mvsa` |
...
| Parser / CLI                            | Geen `.mvsa`-validate of export in v0-draft                             | Na stabiele syntax                                                             |
